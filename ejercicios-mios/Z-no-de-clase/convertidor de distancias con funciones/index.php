...
<head>
    <meta charset="utf-8">
    <title>
        Convertidor de distancias (3) Con funciones (Formulario).
...
<body>
    <h1>Convertidor de distancias (3) Con funciones (Formulario)</h1>

    <form action="convertidord_func" method="get">
        <p>
            Quiero convertir:
